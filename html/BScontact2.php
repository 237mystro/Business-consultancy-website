...
<style>
    * {
    ...
    .container {
        height: 500px;
        bottom: 0 4px 8px rgba(0, 0, 0, 0.2);
        margin: 15px auto;
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="right">
                ...
                <h1 style="color: white; font-size: 18px;"><?php echo "$username"; ?> <p
                        style=" opacity: 0.71; margin-top: 0;font-size: 18px;">Basic plan</p>
                </h1>
            </div>
        </div>
    </header>
