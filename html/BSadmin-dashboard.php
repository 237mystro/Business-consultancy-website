...
<head>
    ...
    <link rel="stylesheet" href="..\BS_css\BSadmin.css">
...
<body>
    <div class="top-bar">
        ...
        <div class="right">
            ...
            <h1><?php echo "$username" ?><p style=" opacity: 0.71; margin-top: 0;">Basic plan</p>
            </h1>
        </div>
    </div>
    <div class="body">
        ...
        <div class="container">
            ...
            <div class="welcome-card">
                <div class="welcome-text">
                    ...
                    <p class="subtext">"If you really look closely, most overnight successes took a long time."</p>
                </div>
                <div class="Girl">
                    <img src="..\BSimages\BSadmin-profile.png" alt="Girl">
                </div>
            </div>

            <div class="text">
                <span>Show <strong>this week &#9662;</strong></span>
            </div>
            ...
            <div class="statistics">
                ...
                <div class="card">
                    <div class="icon">&#128176;</div>
                    <h1>210<span class="currency">AZN</span></h1>
                    <p>Total earnings</p>
                </div>
            </div>
