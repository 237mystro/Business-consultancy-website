...
<head>
    ...
    <link rel="stylesheet" href="../BS_css/setting.css">
...
<style>
    ...
    .right {
        ...
        .profil_pic {
            ...
            background-image: url(../header/image/profile.jpeg);
            background-size: cover;
        }
    }
</style>
...
<body>
    <div class="top-bar">
        ...
        <div class="right">
            ...
            <h1><?php echo "$username" ?><p style=" opacity: 0.71; margin-top: 0; color: black;">Basic plan</p>
            </h1>
        </div>
    </div>
    <div class="body">
        ...
        <div class="profil_edit">
            ...
            <form action="" class="editing">
                <input type="text" placeholder="first name">
                <input type="text" placeholder="last name">
                <input type="password" placeholder="password">
                <textarea name="text" id="" placeholder="description"></textarea>
                <input type="file" id="profil_pic" accept="image/*">
